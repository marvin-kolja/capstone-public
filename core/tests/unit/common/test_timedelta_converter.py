...
from core.common.timedelta_converter import timedelta_to_milliseconds, timedelta_to_seconds, \
    timedelta_to_milliseconds_precise, timedelta_to_seconds_precise
...
def test_timedelta_to_milliseconds_precise():
    ...
    """
    timeout = timedelta(weeks=1, days=1, hours=2, minutes=3, seconds=4, milliseconds=5, microseconds=6)
...
def test_timedelta_to_milliseconds():
    ...
    """
    timeout = timedelta(weeks=1, days=1, hours=2, minutes=3, seconds=4, milliseconds=5, microseconds=501)
...
def test_timedelta_to_seconds():
    ...
    AND: The result is an integer
    """
    timeout = timedelta(weeks=1, days=1, hours=2, minutes=3, seconds=4, milliseconds=500, microseconds=6)
